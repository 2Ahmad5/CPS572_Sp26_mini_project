...
|---|---|---|---|---|---|---|---|
| r1_clean.jsonl | 317218 | 11 | 11 | 1 | 1 | 12 | 13 |

## r1_clean.jsonl

- **IFEval / last_sent**: 11 matches across 11 unique test items. Items (first 10): ['IFEval/1367', 'IFEval/1897', 'IFEval/2097', 'IFEval/2239', 'IFEval/227', 'IFEval/2273', 'IFEval/2417', 'IFEval/281', 'IFEval/2825', 'IFEval/3536']. Sample patterns: ['The title should be wrapped in double angular brackets, i', 'Put your entire response in double quotation marks', '" Put your entire response in double quotation marks']
...
- **HumanEval / docstring_sent_0**: 5 matches across 5 unique test items. Items (first 10): ['HumanEval/133', 'HumanEval/147', 'HumanEval/158', 'HumanEval/90', 'HumanEval/94']. Sample patterns: ['Write a function that accepts a list of strings', 'You are given a positive integer n', 'You are given a list of integers']
...
- **HumanEval / solution_line_0**: 5 matches across 5 unique test items. Items (first 10): ['HumanEval/105', 'HumanEval/155', 'HumanEval/18', 'HumanEval/4', 'HumanEval/55']. Sample patterns: ['return fib(n - 1) + fib(n - 2)', 'mean = sum(numbers) / len(numbers)', 'sorted_arr = sorted(arr, reverse=True)']
